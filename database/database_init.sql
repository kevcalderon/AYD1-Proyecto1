...
SOL_ID BIGINT NOT NULL AUTO_INCREMENT,
EMPRESA_EMP_ID BIGINT,
REPARTIDOR_REP_ID BIGINT,
DIRECCION_DIR_ID BIGINT,
...
ALTER TABLE SOLICITUD ADD CONSTRAINT SOLICITUD_DIRECCION_FK FOREIGN KEY (DIRECCION_DIR_ID) REFERENCES DIRECCION(DIR_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
